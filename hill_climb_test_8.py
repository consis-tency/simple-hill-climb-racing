...
def updateCar(delta_time):
    global car_front_x, car_front_y, car_back_x, car_back_y, car_velocity_y_front, car_velocity_y_back, gravity, car_speed, terrain_offset_x, fuel_level, paused, game_over, hill_render_step_size, WINDOW_WIDTH
...
def checkCollectibleCollision():
    global collectables, car_front_x, car_front_y, car_back_x, car_back_y, fuel_level
    ...
    for collectable in collectables[:]:
        ...
        if (
            ...
            collectables.remove(collectable)  # Remove collected item
